  ...
  const socialReels = [
    {
      ...
      likes: '4.8k',
      commentsCount: 230,
      caption: 'Obsessed with my new 24" Bone Straight Wig! Check the shine and quality double-drawn ends! ✨ #wiginstall #jesambeauty',
      videoUrl: '/videos/p1.mp4',
      poster: '/videos/p1-poster.jpg',
      productId: 'p1',
      productName: '24" Bone Straight Wig',
      price: 185000,
      rating: 4.9,
    ...
    },
    {
      ...
      likes: '3.2k',
      commentsCount: 145,
      caption: 'Unboxing my 18" HD Lace Front Curly Wig! The curl pattern is so juicy, pre-plucked hairline is flawless! 💖 #curls #wigunboxing',
    ...
    },
    {
      ...
      likes: '1.9k',
      commentsCount: 89,
      caption: 'Virgin bundles installation in progress. Soft, full, and no shedding. Jesam Beauty never fails! 👑 #hairvendor #humanhair',
      videoUrl: '/videos/p3.mp4',
      poster: '/videos/p3-poster.jpg',
      productId: 'p3',
      productName: '3 Bundles Raw Virgin Hair',
      price: 120000,
      rating: 5.0,
    ...
    },
    {
      ...
      likes: '2.5k',
      commentsCount: 112,
      caption: 'My daily care routine using Jesam\'s Silk Serum. Keeps my wigs silky and frizz-free all day long. A must-buy! 🛍️ #haircare #wigtips',
      videoUrl: '/videos/p4.mp4',
      poster: '/videos/p4-poster.jpg',
      productId: 'p4',
      productName: 'Jesam Hair Silk Serum & Oil',
      price: 8500,
      rating: 4.7,
      music: 'Summer Vibes - linda_styles',
      comments: [
        { user: '@stella_d', text: 'This serum is literally magic in a bottle.' },
        { user: '@chi_chi', text: 'Does it make the hair oily or heavy?' },
        { user: '@linda_styles', text: 'Super lightweight! Just 1-2 drops is enough.' }
      ]
    }
  ];
