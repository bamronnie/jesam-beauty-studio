...
export const mockProducts = [
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1579613832125-5d34a13feb2a?q=80&w=500',
      'https://images.unsplash.com/photo-1605497746444-ac9dbd39d675?q=80&w=500'
    ],
    video: '/videos/p1.mp4',
    ...
    reviews: 2,
    reviewsList: [
      { username: 'Amina Y.', rating: 5, comment: 'Absolutely lovely! Super soft and doesn\'t tangle at all.', date: new Date('2026-06-15') },
      { username: 'Blessing O.', rating: 4, comment: 'Very sleek, though I wish it came pre-plucked a bit more.', date: new Date('2026-07-02') }
    ]
  },
  {
    _id: 'mock-p2',
...
export const mockUsers = [
  {
    _id: 'mock-usr1',
    name: 'Chidi Okafor',
    email: 'customer@jesambeauty.com',
...
// Hash mock passwords immediately
const salt = bcrypt.genSaltSync(10);
mockUsers[0].password = bcrypt.hashSync('password123', salt);
mockUsers[1].password = bcrypt.hashSync('admin123', salt);
